...
from utils.api import api_response, sanitize_email, sanitize_string
...
def is_strong_password(password):
    # Min 8 chars, 1 upper, 1 lower, 1 num, 1 special (any non-alphanumeric)
...
def login():
    ...
    # Generic failure response for unknown or locked users
    if not user:
