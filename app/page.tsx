          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold mb-2">Book a Test</h3>
                <p className="text-gray-600">Select your test and preferred time</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-900 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                  2
                </div>
                <h3 className="font-bold mb-2">Confirm Address</h3>
                <p className="text-gray-600">Provide your home address</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-900 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                  3
                </div>
                <h3 className="font-bold mb-2">Home Visit</h3>
                <p className="text-gray-600">Our technician visits your home</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-900 text-white rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4 text-lg font-bold">
                  4
                ...
                <p className="text-gray-600">Results within 24 hours</p>
              </div>
            </div>
          </div>
        </section>
